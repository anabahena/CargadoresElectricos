class UI {
    ...
    mapInit() {
            ...
            function buscarLocalizacion(e) {
                L.marker(e.latlng, {
                    icon: customIcon
                }).bindPopup(optionsPopUp).openPopup().addTo(map);
            }
    ...
    border: 1px solid #FFFFFF`;
                ...
                ], { icon: icon }).bindPopup(optionsPopUp);
    ...
    border: 1px solid #FFFFFF`;
                ...
                // Agregar el Pin
                const marker = new L.marker(
                    [parseFloat(geolocation.latitude), parseFloat(geolocation.longitude)], { icon: icon }
